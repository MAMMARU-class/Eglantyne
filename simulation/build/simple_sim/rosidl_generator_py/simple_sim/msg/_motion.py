...
class Metaclass_Motion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('simple_sim')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'simple_sim.msg.Motion')
            logger.debug(
...
class Motion(metaclass=Metaclass_Motion):
    ...
    _fields_and_field_types = {
        'motion': 'sequence<trajectory_msgs/JointTrajectoryPoint>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motion' field must be a set or sequence and each value of type 'JointTrajectoryPoint'"
        self._motion = value
