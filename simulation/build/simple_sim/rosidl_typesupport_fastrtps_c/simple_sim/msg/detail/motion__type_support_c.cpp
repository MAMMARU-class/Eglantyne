...
#include "simple_sim/msg/detail/motion__rosidl_typesupport_fastrtps_c.h"
...
#include "simple_sim/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "trajectory_msgs/msg/detail/joint_trajectory_point__functions.h"  // motion

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_simple_sim
...
using _Motion__ros_msg_type = simple_sim__msg__Motion;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motion
  {
    ...
    auto array_ptr = ros_message->motion.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motion
  {
    ...
    if (ros_message->motion.data) {
      trajectory_msgs__msg__JointTrajectoryPoint__Sequence__fini(&ros_message->motion);
    }
    if (!trajectory_msgs__msg__JointTrajectoryPoint__Sequence__init(&ros_message->motion, size)) {
      fprintf(stderr, "failed to create array for field 'motion'");
      return false;
    }
    auto array_ptr = ros_message->motion.data;
    for (size_t i = 0; i < size; ++i) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simple_sim
size_t get_serialized_size_simple_sim__msg__Motion(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Motion__ros_msg_type * ros_message = static_cast<const _Motion__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Motion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simple_sim__msg__Motion(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simple_sim
size_t max_serialized_size_simple_sim__msg__Motion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simple_sim__msg__Motion;
    is_plain =
      (
...
static size_t _Motion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simple_sim__msg__Motion(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simple_sim, msg, Motion)() {
